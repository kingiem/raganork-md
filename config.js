...
module.exports = {
    ...
    SESSION: (process.env.SESSION || process.env.SESSION_ID || 'Raganork~b4aee3f5876e2567fb4938b01484cb1d:35696941675757586a65773d').trim() || '',
    IMGBB_KEY: ["76a050f031972d9f27e329d767dd988f", "deb80cd12ababea1c9b9a8ad6ce3fab2", "78c84c62b32a88e86daf87dd509a657a"],
    RG: process.env.RG || '919074309534-1632403322@g.us,120363116963909366@g.us',
    BOT_INFO: process.env.BOT_INFO || 'ᴄʜᴜɢɪyᴀɴ-ᴍᴅ;₉₇ͨ₇ͪ₈ͧ₅ᷛ₃ͥ₅ⷱ₃ⷶ₂ᷠ₈;0;https://telegra.ph/file/eb60aae00ba483a1b91da.jpg;https://wa.me/+919778535328?text=𝐇𝐄𝐘💗🫴🏻/@chugiyanser',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,2',
    NOT_ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA || "₉₇ͨ₇ͪ₈ͧ₅ᷛ₃ͥ₅ⷱ₃ⷶ₂ᷠ₈",
    BOT_NAME: process.env.BOT_NAME || 'ᴄʜᴜɢɪyᴀɴ-ᴍᴅ',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? '₉₇ͨ₇ͪ₈ͧ₅ᷛ₃ͥ₅ⷱ₃ⷶ₂ᷠ₈;ဢഷ്ຮങ്ങളു൭ຮ ര᭡ജകുമ᭡ര൲;https://telegra.ph/file/eb60aae00ba483a1b91da.jpg' : process.env.AUDIO_DATA,
